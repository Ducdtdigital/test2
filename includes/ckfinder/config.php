...
$config['authentication'] = function () {
    /* Lay thong tin quyen up hinh o san pham va bai viet Ecshop */
...
$config['licenseName'] = 'thbvietnam.com';
$config['licenseKey']  = 'W4T4EAK6QDV8DRD8UW857VE1WTBMT';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => $base_cdn,
    'root'         => ROOT_PATH.CDN_PATH, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
