...
class AmpHelper
{
    ...
    public static $htmlTagAttributeToRemove = ['style', 'size', 'cropbottom', 'croptop', 'mkey', 'cropleft', 'cropright', 'border', 'align', 'nowrap', 'clear', 'color', 'textvalue', '_src', 'type', 'face', 'vspace', 'contenteditable', 'onclick'];
