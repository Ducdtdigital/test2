...
class ErrorHandler
{
    ...
    public function handleError($errno, $errstr, $errfile, $errline, $errcontext)
    {
        ...
        $errormsg .= "<h3 style='font-size:36px;font-weight:500'>Lỗi hệ thống Ecshop vui lòng liên hệ Email Ducdtdigital@gmail.com</h3>\n
    ...
    public function handleException(Exception $Exception)
    {
        ...
        $exception .= "<h3 style='font-size:36px;font-weight:500'>Lỗi hệ thống Ecshop vui lòng liên hệ Email Ducdtdigital@gmail.com</h3>\n
             <p>The application could not run because of the following error: </p>\n
