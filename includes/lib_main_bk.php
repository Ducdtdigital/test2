    ...
    if($filename=='index')
    {
        ...
        else
        {
            if ('group_buy' == $module)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
               <a itemprop="item" href="/nhom-mua"><span itemprop="name">' . $GLOBALS['_LANG']['group_buy_goods'] . '</span></a>
               <meta itemprop="position" content="2"></li>';
            }
            elseif ('wholesale' == $module)
            {
                $page_title = $GLOBALS['_LANG']['wholesale'] . '-' . $page_title;
                $args       = array('wsid' => '0');
                $ur_here    .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
               <a itemprop="item" href="/ban-si"><span itemprop="name">' . $GLOBALS['_LANG']['group_buy_goods'] . '</span></a>
               <meta itemprop="position" content="2"></li>';
            }
            elseif ('cat_exchange' == $module)
            {
                $page_title = $GLOBALS['_LANG']['exchange'] . '-' . $page_title;
                $args       = array('wsid' => '0');
                $ur_here    .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a itemprop="item" href="/tich-diem-doi-qua"><span itemprop="name">' . $GLOBALS['_LANG']['exchange_goods'] . '</span></a>
                <meta itemprop="position" content="2"></li>';
            }
            elseif ('exchange' == $module)
            {
                $page_title = $GLOBALS['_LANG']['exchange'] . '-' . $page_title;
                $args       = array('wsid' => '0');
                $ur_here    .= '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
...
function assign_template($ctype = '', $catlist = array())
{
    global $smarty;
    /** @var edit by Nobj */
    $stats_code = isset($_COOKIE['dev']) && $_COOKIE['dev'] == 'test' ? '' : $GLOBALS['_CFG']['stats_code'];
...
function get_library_number($library, $template = null)
{
    ...
    if (empty($template))
    {
        ...
        $template = CURRENT_TEMPLATE; //edit by Nobi
