...
$_LANG['os'][OS_SPLITED] = 'Đã tạo vận đơn';
...
$_LANG['op_confirm'] = 'B1. Xác nhận';
$_LANG['op_pay'] = 'B2. Xác nhận Thanh toán';
$_LANG['op_prepare'] = 'B3a. Set Chuẩn bị giao hàng';
$_LANG['op_ship'] = 'B6. Set Đã giao hàng';
$_LANG['op_cancel'] = 'Hủy bỏ';
$_LANG['op_invalid'] = 'Không hợp lệ';
$_LANG['op_return'] = 'Set Trả lại hàng';
$_LANG['op_unpay'] = 'B3b. Set lại là chưa thanh toán';
$_LANG['op_unship'] = 'Chưa vận chuyển';
$_LANG['op_cancel_ship'] = 'Hủy bỏ vận chuyển';
$_LANG['op_receive'] = 'Set KH Đã nhận hàng';
...
$_LANG['op_split'] = 'B4. Tạo vận đơn';
$_LANG['op_to_delivery'] = 'B5. Chuyển đến Bộ phận Giao hàng';
/* Danh sách đơn hàng */
...
$_LANG['price_note'] ='Lưu ý: Giá này đã bao gồm giá theo thuộc tính.';
...
$_LANG['change_use_surplus'] = 'Thanh toán cho đơn hàng %s';
$_LANG['change_use_integral'] = 'Thanh toán cho đơn hàng %s';
$_LANG['return_order_surplus'] = 'Lấy lại tiền, lí do trả lại hàng %s. ';
$_LANG['return_order_integral'] = 'Lấy lại điểm, lí do trả lại hàng %s. ';
$_LANG['order_gift_integral'] = 'Điểm quà tặng đơn hàng %s';
$_LANG['return_order_gift_integral'] = 'Lấy lại điểm, lí do trả lại hàng %s. ';
