...
else
{
    ...
    else
    {
        ...
        if (file_exists($plugin_file))
        {
            ...
            $pay_status = $payment->respond();
            $msg     = $pay_status == true ? $_LANG['pay_success'] : $_LANG['pay_fail'];
...
$msg_type = $pay_status == true ? 'success' :'notice';
$smarty->assign('msg_type',  $msg_type);
$smarty->assign('msg',    $msg);
$smarty->assign('shop_url',   $ecs->url());

$smarty->display('respond'.$_device.'.dwt');
