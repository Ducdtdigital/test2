    ...
    $.post(
        ...
        function(response){
            ...
            if (res.error > 0) {
                ...
                $.fn.colorbox({fixed:true,scrolling: false, transition: 'fade', html:'<div class="message_box mb_question">Thêm giỏ hàng thành công ! <p class="action"><a href="'+base_path+'gio-hang" class="button brighter_button"><span>Thanh Toán</span></a><a href="javascript:void(0);" class="tool_link" onclick="$.fn.colorbox.close(); return false;">Mua Tiếp</a></p></div>'});
            }
        },
        'text'
    );
