<!-- $Id: goods_export.htm 17107 2010-04-15 03:29:13Z liuhui $ --> <?php echo $this->fetch('pageheader.htm'); ?> 
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>

<?php echo $this->smarty_insert_scripts(array('files'=>'build_url.js')); ?>
<table width="100%">
  <tr>
    <td>
      <div class="main-div" style="background-color: white;"> <?php echo $this->_var['lang']['user_guide']; ?> <h3>
          <center><?php echo $this->_var['lang']['export_condition']; ?></center>
        </h3>
        <div>
          <form action="goods_export.php" method="post" name="searchForm" onsubmit="return queryGoods(this)">
            ...
            <select class="select2" name="cat_id" >
              <option value="0"><?php echo $this->_var['lang']['custom_goods_cat']; ?></option><?php echo $this->_var['cat_list']; ?>
            </select>
            <!-- 品牌 -->
            <select class="select2" name="brand_id">
              <option value="0"><?php echo $this->_var['lang']['custom_goods_brand']; ?></option><?php echo $this->html_options(array('options'=>$this->_var['brand_list'])); ?>
            </select>

            <select class="select2" name="intro_type">
              
            </select>
            
            <!-- 关键字 --> <?php echo $this->_var['lang']['custom_keyword']; ?> <input type="text" name="keyword" />
            <!-- 搜索 -->
        ...
        <table>
          <tr>
            ...
            <td rowspan="2" width="8%" style="text-align:center;">
              <p>
                <input type="button" value=">>" id="addAllGoods" class="button" />
              </p>
              <p>
                <input type="button" value=">" id="addGoods" class="button" />
              </p>
              <p>
                <input type="button" value="<" id="delGoods" class="button" />
              </p>
              <p>
                <input type="button" value="<<" id="delAllGoods" class="button" />
              </p>
            </td>
            <td width="46%">
              <select name="dst_goods_lists" id="dst_goods_lists" size="14" style="width:100%" multiple="true"></select>
            </td>
          </tr>
        </table>
        <div>
...
<div id="taobao_form" style="display:none">
  <form action="goods_export.php" method="post" name="theForm1" onsubmit="return formValidate1()">
    <table width="100%">
      <tr>
        <td class="label">
          <a href="javascript:showNotice('noticeGoodsClass');" title="<?php echo $this->_var['lang']['form_notice']; ?>">
            <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>">
          </a><?php echo $this->_var['lang']['goods_class']; ?>
        </td>
        <td>
          <input type="text" name="goods_class" value="0" />
          <br />
          <!-- <span class="notice-span"  <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?>  id="noticeGoodsClass"> -->
          <span class="notice-span"><?php echo $this->_var['lang']['notice_goods_class']; ?></span>
        </td>
      </tr>
      <tr>
        <td class="label"><?php echo $this->_var['lang']['post_express']; ?></td>
        <td>
          <input type="text" name="post_express" value="0" />
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="express" value="0" />
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input type="text" name="ems" value="0" />
        </td>
      </tr>
    ...
    <table width="100%">
      <tr>
        ...
        <td>
          <input type="text" name="goods_class" value="0" />
          <br />
          <span class="notice-span" id="noticeGoodsClass"><?php echo $this->_var['lang']['notice_goods_class']; ?></span>
      </tr>
      <tr>
        <td class="label"><?php echo $this->_var['lang']['post_express']; ?></td>
        <td>
...
<div id="custom_form" style="display:none" onsubmit="return formValidate4()">
<form action="goods_export.php" method="post" name="theForm4">
	<table width="100%">
		<tbody>
			<tr>
				<td class="label"><?php echo $this->_var['lang']['custom_date_export']; ?></td>
				<td>
					<input type="text" name="date_export" value="<?php echo $this->_var['date_export']; ?>">
				</td>
			</tr>
			<tr>
				<td class="label"><?php echo $this->_var['lang']['custom_export_to']; ?></td>
				<td>
					<input type="text" name="export_to" size="80" value="">
				</td>
			</tr>
			<tr>
				<td class="label"><?php echo $this->_var['lang']['custom_export_address']; ?></td>
				<td>
					<input type="text" name="export_address" size="80" value="">
				</td>
			</tr>
			<tr>
				<td class="label"><?php echo $this->_var['lang']['custom_export_tel']; ?></td>
				<td>
					<input type="text" name="export_tel" size="80" value="">
				</td>
			</tr>
			<tr>
				<td class="label"><?php echo $this->_var['lang']['custom_export_email']; ?></td>
				<td>
					<input type="text" name="export_email" size="80" value="">
				</td>
			</tr>
			<tr>
				<td>
...
<div id="export_product_form" style="display:none" onsubmit="return formValidateExportProduct()">
<form action="goods_export.php" method="post" name="ExportProduct">
	<table width="100%">
		<tbody>
			<tr>
				<td class="label">Tên file</td>
				<td>
					<input type="text" name="export_name" size="80" value="Export Product">
				</td>
			</tr>
			<tr>
				<td class="label">Tên sheet</td>
				<td>
					<input type="text" name="export_sheet" size="80" value="List Product">
				</td>
			</tr>
			<tr>
				<td>
					...
					<input name="keyword" type="hidden" value="">
					<input name="goods_ids" type="hidden" value="">
					<input type="hidden" name="act" value="act_export_product">
					<input type="hidden" name="custom_goods_export" value="">
				</td>
				<td>
					<input name="submit" type="submit" id="submit" value="<?php echo $this->_var['lang']['button_submit']; ?>" class="button">
...
<script language="JavaScript">
  ...
  function formValidateExportProduct() {
    var elements = document.forms['ExportProduct'].elements;
    var msg = '';
    if (elements['export_name'].value == '')
    {
        msg += 'Phải nhập tên file' + '\n';
    }
    if (elements['export_sheet'].value == '')
    {
        msg += 'Phải nhập tên sheet' + '\n';
    }
    if (msg.length > 0)
    {
        alert(msg);
        ...
        var src_obj = document.forms['searchForm'];
        var dst_obj = document.forms['ExportProduct'];
        copy_search_result(src_obj, dst_obj);
        return true;
    }
  }
...
var MySelectBox2;
if (!MySelectBox) {
  var global = $import("../js/global2.js", "js");
