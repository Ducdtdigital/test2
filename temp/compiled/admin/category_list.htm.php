...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <td width="10%"><img src="images/<?php if ($this->_var['cat']['show_cat_home'] == '1'): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_show_cat_home', <?php echo $this->_var['cat']['cat_id']; ?>)" /></td>
    ...
    <td width="24%" align="center">
      <a href="../<?php echo $this->_var['cat']['url']; ?>" target="_blank">View</a> |
