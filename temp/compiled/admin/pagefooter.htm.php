...
<div class="warning_box" id="popMsg">
    ...
    <p><a href="order.php?act=list"><?php echo $this->_var['lang']['new_order_1']; ?><strong id="spanNewOrder">1</strong><?php echo $this->_var['lang']['new_order_2']; ?><strong id="spanNewPaid">0</strong><?php echo $this->_var['lang']['new_order_3']; ?></a></p>
</div>
<!--
...
<?php echo $this->smarty_insert_scripts(array('files'=>'init.js')); ?>
<script language="JavaScript">
<!--
<?php if ($this->_var['enable_order_check'] == '0'): ?>startCheckOrder = function(){}<?php endif; ?>
//-->
</script>
<?php if ($this->_var['option']['send_mail_on'] == 'on'): ?>
<div id="send_msg">
    <p><?php echo $this->_var['lang']['email_sending']; ?><a href="javascript:;" onClick="Javascript:switcher()" id="lnkSwitch" class="action"><?php echo $this->_var['lang']['pause']; ?></a></p>
</div>
      <script>
