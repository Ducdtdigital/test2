...
$template_files = array(
    ...
    'article_mobile.dwt',
    'article_cat.dwt',
    'article_cat_mobile.dwt',
    'article_cat_index.dwt',
    'article_cat__index_mobile.dwt',
    'brand.dwt',
    'category.dwt',
    'category_mobile.dwt',
    'user_clips.dwt',
...
$page_libs = array(
    'article' => array(
        ...
        '/library/new_articles.lbi' => 5,
        '/library/goods_related.lbi' => 4,
    ...
    'article_cat_mobile' => array(
        '/library/recommend_best_mobile.lbi' => 3,
        '/library/recommend_new_mobile.lbi' => 3,
        '/library/recommend_hot_mobile.lbi' => 3,
    ),
    'article_cat_index' => array(
        '/library/ur_here.lbi' => 0,
        '/library/article_category_tree.lbi' => 0,
    ),
    'article_cat_index_mobile' => array(
        '/library/ur_here.lbi' => 0,
        '/library/article_category_tree.lbi' => 0,
    ),
    'brand' => array(
    ...
    'category_mobile' => array(
        '/library/recommend_best_mobile.lbi' => 3,
        '/library/recommend_hot_mobile.lbi' => 3,
        '/library/goods_list_mobile.lbi' => 0
    ),
    'compare' => array(
        '/library/ur_here.lbi' => 0,
        '/library/search_form.lbi' => 0,
    ...
    'index' => array(
        ...
        '/library/category_tree.lbi' => 0,
        '/library/recommend_best.lbi' => 20,
        '/library/recommend_new.lbi' => 20,
        '/library/recommend_hot.lbi' => 20,
    ...
    'index_mobile' => array(
        '/library/recommend_best_mobile.lbi' => 6,
        '/library/recommend_new_mobile.lbi' => 6,
        '/library/recommend_hot_mobile.lbi' => 6,
        '/library/recommend_promotion_mobile.lbi' => 6,
    ),
    'goods' => array(
        '/library/promotion_info.lbi' => 0,
        '/library/category_tree.lbi' => 0,
...
/**
 * Lấy danh sách các Region trong template
 *
 * @access  public
 * @param   string  $tmp_name   folder themes name
 * @param   string  $tmp_file   template file
 * @param   bolean  $lib   Nếu true thì chỉ lấy .dwt
 * @return  array
 */
