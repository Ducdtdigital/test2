...
$modules['02_cat_and_goods']['15_batch_edit']       = 'updatesp.php';
...
$modules['08_members']['05_comment_manage']         = 'comment_manage.php?act=list';
...
$modules['11_system']['11_phone_sale']             = 'phone_sale.php?act=list';
...
$modules['11_system']['file_check']                 = 'indexapi/admin.php?page=instant-indexing&tab=console';
//$modules['11_system']['fckfile_manage']             = 'fckfile_manage.php?act=list';
$modules['11_system']['redirect']                   = 'redirect.php?act=list';
