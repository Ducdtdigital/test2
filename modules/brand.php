...
if (!$smarty->is_cached($_template, $cache_id))
{
    ...
    if(isset($cate_info['cat_name'])){
        $page_title = $brand_info['brand_meta_title'];
        $keywords = $brand_info['brand_keyword'];
    }else{
        $page_title = $brand_info['brand_name'];
        $page_title_brand = $brand_info['brand_meta_title'];
        $keywords = $brand_info['brand_keyword'];
    }
    ...
    $smarty->assign('page_title_brand',    $page_title_brand);
