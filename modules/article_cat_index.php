...
$_teamplate = 'article_cat_index'.$_device.'.dwt';
if (!$smarty->is_cached($_teamplate, $cache_id))
{
    ...
    /* Meta */
    $meta = $db->getRow("SELECT cat_name, meta_title, keywords, cat_desc FROM " . $ecs->table('article_cat') . " WHERE cat_id = '$cat_id'");
    ...
    $page_title = htmlspecialchars($meta['meta_title']).$page_number_title.' - '.$_CFG['shop_name'];
    ...
    /** Lấy danh mục tin tức của riêng danh mục cat_id 18 */
    //$smarty->assign('article_categories',   article_categories_treev2(18));
   ...
   // $smarty->assign('best_goods',           get_recommend_goods('best'));
    ...
    assign_dynamic('article_cat_index');
}
